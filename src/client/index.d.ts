...
export interface ZillowPropertyMinimalByUrlParams {
  url?: string;
}
...
export interface ZillowLotIdFromAddressParams {
  propertyaddress?: string;
}
...
export interface ZillowSearchByCoordinatesParams extends Omit<ZillowSearchByAddressParams, "location"> {
  latitude?: string | number;
  longitude?: string | number;
  radius?: string | number;
}

export interface ZillowSearchByMapBoundsParams extends Omit<ZillowSearchByAddressParams, "location"> {
  eastLongitude?: string | number;
  northLatitude?: string | number;
  southLatitude?: string | number;
...
export interface ZillowHousingMarketParams {
  search_query?: string;
  home_type?: "All_Homes" | "Single_Family" | "Condo" | string;
  exclude_rentalMarketTrends?: string | boolean;
...
export interface ZillowAgentForRentPropertiesParams {
  encodedZuid: string;
  page?: string | number;
}

export interface ZillowAgentSoldPropertiesParams {
  encodedZuid: string;
  page?: string | number;
}

export interface ZillowAgentReviewsParams {
  encodedZuid: string;
  page?: string | number;
...
export interface ZillowRentZestimateHistoryParams {
  recent_first?: "True" | "False" | string;
  which?: "rent_zestimate_history" | string;
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
}
...
export interface ZillowZestimatePercentChangeParams {
  recent_first?: "True" | "False" | string;
  which?: "zestimate_percent_change" | string;
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
}
...
export interface ZillowTaxPaidParams {
  recent_first?: "True" | "False" | string;
  which?: "tax_paid" | string;
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
}

export interface ZillowOwnerAgentParams {
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
}

export interface ZillowComparableHomesParams {
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
}
...
export interface ZillowNearbyPropertiesParams {
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
  bylotid?: string | number;
...
export interface ZillowPropertyImagesParams {
  byzpid?: string | number;
  byurl?: string;
  byaddress?: string;
}
...
export interface ZillowLotIdFromAddressResponse {
  message?: string;
  source?: string;
...
export interface ZillowHousingMarketResponse {
  message?: string;
  source?: string;
  search_query?: string;
...
export interface ZillowAgentForRentPropertiesResponse {
  message?: string;
  source?: string;
  forRentListings?: Array<Record<string, unknown>>;
  listingCount?: number;
  [key: string]: unknown;
}

export interface ZillowAgentSoldPropertiesResponse {
  message?: string;
  source?: string;
  pastSales?: Array<Record<string, unknown>>;
  pastSalesCount?: number;
  [key: string]: unknown;
}

export interface ZillowAgentReviewsResponse {
  message?: string;
  source?: string;
...
export interface ZillowTaxPaidResponse extends ZillowZestimateHistoryResponse {}

export interface ZillowOwnerAgentResponse {
  message?: string;
  source?: string;
  zpid?: string;
  isListedByOwner?: boolean;
  forSaleOrSold_ListingContact?: Record<string, unknown> | null;
  rentalListingContact?: Record<string, unknown> | null;
  [key: string]: unknown;
}

export interface ZillowComparableHomesResponse {
  message?: string;
  source?: string;
  zpid?: string;
...
export interface ZillowNearbyPropertiesResponse {
  message?: string;
  source?: string;
...
export interface ZillowPropertyImagesResponse {
  message?: string;
  source?: string;
  propertyURL?: string;
...
export interface MintApiZillowClient {
  ...
  agentForRentProperties<T = ZillowAgentForRentPropertiesResponse>(
    params: ZillowAgentForRentPropertiesParams,
  ): Promise<T>;
